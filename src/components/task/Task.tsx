...
const getSwitchersConfig = (taskType: TaskVariantType, changeTaskType: (type: TaskVariantType) => void, removeTask: () => void) => {
  return {
...
const switchTaskVariants = (taskType: TaskVariantType, changeTaskType: (type: TaskVariantType) => void, removeTask: () => void) => {
    ...
    <li className={`task task--${data.type}`} id={data.id}>
      <header className='task__header'>
        ...
        <div className='task__header-controls'>
          {switchTaskVariants(data.type, changeTaskType, () => removeTask(data.id))}
        </div>
      </header>
